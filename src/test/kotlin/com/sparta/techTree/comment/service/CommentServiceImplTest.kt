...
class CommentServiceImplTest {
    ...
    fun `createComment saves and returns comment`() {
        ...
        val createCommentRequest = CreateCommentRequest(1, 1, 1, "New comment", testDateTime, null, null)
        val savedComment = Comment(1,
            createCommentRequest.userId, createCommentRequest.postId, createCommentRequest.content, LocalDateTime.now(), null, null)
        val commentService = CommentServiceImpl(commentRepository)
